...
public class MainActivity extends AppCompatActivity {
    ...
    static final String keyToStore = "query";
    static final String keyToStoreSearch = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            String query = savedInstanceState.getString(keyToStore);
            String rawJson = savedInstanceState.getString(keyToStoreSearch);
    ...
    public void onSaveInstanceState(Bundle outState, PersistableBundle outPersistentState) {
        ...
        outState.putString(keyToStore, query);
        String rawJsonSearchResults = mSearchResultsTextView.getText().toString();
        outState.putString(keyToStoreSearch, rawJsonSearchResults);
    }
